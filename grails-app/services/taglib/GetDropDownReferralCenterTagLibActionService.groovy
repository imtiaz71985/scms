...
@Transactional
class GetDropDownReferralCenterTagLibActionService extends BaseService implements ActionServiceIntf  {
    ...
    public Map execute(Map result) {
        try {
            List<ReferralCenter> lstReferralCenter=ReferralCenter.findAllByIsActive(true)
            String html = buildDropDown(lstReferralCenter, result)
            result.html = html
            return result
        } catch (Exception e) {
            log.error(e.message)
     ...
     * @return - html string for select
     */
    private String buildDropDown(List<ReferralCenter> lstValues, Map dropDownAttributes) {
        // read map values
