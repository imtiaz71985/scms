...
@Transactional
class ListServiceHeadInfoActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        ...
        try {
            ...
            if(serviceTypeId>0){
                ...
                resultMap = super.getSearchResult(result, ListServiceHeadInfoActionServiceModel.class)
            }
