...
@Transactional
class ListServiceProviderActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        try {
            Map resultMap = super.getSearchResult(result, ListServiceProviderActionServiceModel.class)
