...
@Transactional
class ListMedicinePriceActionService extends BaseService implements ActionServiceIntf {
    ...
    public Map execute(Map result) {
        try {
            long medicineId = Long.parseLong(result.medicineId.toString())
            Closure additionalParam = {
                eq("medicineId", medicineId)
            }
            Map resultMap = super.getSearchResult(result, ListMedicinePriceActionServiceModel.class,additionalParam)
