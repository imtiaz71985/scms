...
@Transactional
class SelectRequisitionPRActionService extends BaseService implements ActionServiceIntf {
    ...
    private static Map wrapEducationGrid(List<RequisitionDetails> lstMedicine) {
        ...
        for (int i = 0; i < lstMedicine.size(); i++) {
            ...
            int approvedQty = singleRow.approvedQty
            double amount = singleRow.amount
            double approveAmount = singleRow.approveAmount
