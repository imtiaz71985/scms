...
@Transactional
class DownloadPurchaseReceiveActionService extends BaseService implements ActionServiceIntf {

    JasperService jasperService
    SpringSecurityService springSecurityService

    private static final String REPORT_FOLDER = 'requisition'
    private static final String JASPER_FILE = 'chalanReceiveReport'
    private static final String REPORT_TITLE_LBL = 'reportTitle'
    private static final String REPORT_TITLE = 'Medicine Receive'
    private static final String OUTPUT_FILE_NAME = "medicine_receive"
