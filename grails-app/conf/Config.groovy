...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.scms.SecUser'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.scms.SecUserSecRole'
grails.plugin.springsecurity.authority.className = 'com.scms.SecRole'
grails.plugin.springsecurity.requestMap.className = 'com.scms.FeatureManagement'
