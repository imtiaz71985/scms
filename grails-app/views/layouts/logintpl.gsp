...
<head>
    ...
    <style>
        body {
            background-image:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' version='1.1' height='50px' width='100px'><text x='5' y='15' fill='lightgray' font-size='8'>Hatia Static Clinic</text></svg>");
        }
    </style>
</head>
