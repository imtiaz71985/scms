...
<script language="JavaScript">
    ...
    function initDataSourceRegAndServiceInfo() {
        dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "${createLink(controller: 'counselorAction', action: 'subsidyList')}?hospitalCode="+hospitalCode+"&dateField="+dateField,
                    dataType: "json",
                    type: "post"
                }
            },
            ...
            aggregate: [
                {field: "subsidy_amt", aggregate: "sum" }
            ],
            pageSize: false,
            serverPaging: false,
