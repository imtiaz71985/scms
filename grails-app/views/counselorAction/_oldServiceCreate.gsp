<div class="container-fluid">
        ...
        <div id="application_top_panel" class="panel panel-primary">
            <div class="panel-heading">
                <div class="panel-title">
                    Search Criteria For Old Service
                </div>
            </div>

            <g:form name='searchByDateAndRegForm' id='searchByDateAndRegForm' class="form-horizontal form-widgets" role="form">
    ...
    <div class="row" id="counselorActionRow">
        <div id="application_top_panel1" class="panel panel-primary">
            ...
            <g:form name='oldServiceActionForm' id='oldServiceActionForm' class="form-horizontal form-widgets"
                    role="form">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-6" style=" padding-bottom: 0px;">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label label-optional" for="txtRemarks">Remarks:</label>

                                <div class="col-md-6">
                                    <textarea id="txtRemarks" name="txtRemarks" required validationMessage="Required" class="form-control"></textarea>
                                </div>
                                <div class="col-md-3 pull-left">
