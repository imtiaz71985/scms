            ...
            <g:form name='returnSummaryRptForm' id='returnSummaryRptForm' class="form-horizontal form-widgets" role="form">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-md-1 control-label label-required" for="returnTypeId" style="padding-left: 0px; padding-right: 0px;">Return Type:</label>
                        <div class="col-md-2">
                            <app:dropDownSystemEntity
                                    data_model_name="dropDownReturnType"
                                    id="returnTypeId" name="returnTypeId" tabindex="1"
