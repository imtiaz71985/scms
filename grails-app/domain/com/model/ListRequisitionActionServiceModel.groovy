...
class ListRequisitionActionServiceModel {
    ...
    public static final String SQL_LIST_REQUISITION_MODEL = """
              CREATE OR REPLACE VIEW list_requisition_action_service_model AS
                      ...
                      SELECT r.id,r.version, r.req_no AS requisition_no,r.create_date AS requisition_date, u.employee_name AS requisition_by,
                          ROUND(r.total_amount,2) AS total_amount,r.is_approved,au.employee_name AS approved_by,r.approved_date,r.is_send,hl.code AS hospital_code,
