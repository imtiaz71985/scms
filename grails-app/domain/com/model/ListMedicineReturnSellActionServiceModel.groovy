...
class ListMedicineReturnSellActionServiceModel {
    ...
    public static final String SQL_LIST_SELL_RETURN_MODEL = """
           CREATE OR REPLACE VIEW list_medicine_return_sell_action_service_model AS
                  ...
                  SELECT mr.id, mr.version, mr.trace_no,mr.return_date,mr.hospital_code,mr.total_amount,u.employee_name AS return_by,mr.return_type_id,se.name AS return_type
                    FROM medicine_return mr
                    LEFT JOIN login_auth.sec_user u ON u.id= mr.return_by
